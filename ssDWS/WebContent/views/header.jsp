							...
							<div class="col-md-8">
								<div class="navbar-callus text-left sm-text-center">
									<ul class="list-inline">
										<li><i class="fa fa-map-marker"></i> Dahachowk,
											Kathmandu, Nepal</li>&nbsp; &nbsp;
